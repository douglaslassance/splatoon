# Vendored from TripoSplat (https://github.com/VAST-AI-Research/TripoSplat), MIT-licensed.
# Only change: the internal `from .model import` was made package-relative.
import numpy as np
import torch
